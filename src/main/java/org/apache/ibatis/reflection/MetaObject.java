...
public class MetaObject {
  ...
  private MetaObject(Object object, ObjectFactory objectFactory, ObjectWrapperFactory objectWrapperFactory,
    ...
    //默认情况下的 DefaultObjectWrapperFactory 未实现任何逻辑，所以这块逻辑相当于暂时不起作用。
    // 如果想要起作用，需要自定义 ObjectWrapperFactory 的实现类
   ...
   * 设置指定属性的指定值
   * <p>
   * 可以调试下 MetaObjectTest#shouldGetAndSetNestedMapPairUsingArraySyntax() 这个单元测试方法。
   *
   * @param name
   * @param value
   */
  ...
  /**
   * 判断是否为集合.直接调用 objectWrapper 的对应的方法。
   * @return
   */
